...
import 'package:flutter_in_action_2/utils/page.dart';
import 'package:flutter_in_action_2/utils/sliver_header_delegate.dart';
...
class NestedScrollViewRoute extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('NestedScrollView示例')),
      body: ListPage(
        children: [
          ...
          return <Widget>[
            SliverAppBar(
              ...
              flexibleSpace: FlexibleSpaceBar(
                background: Image.asset("res/image/sea.png", fit: BoxFit.cover),
              ),
              forceElevated: innerBoxIsScrolled,
            ),
          ];
